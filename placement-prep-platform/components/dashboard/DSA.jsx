...
export default function DSA() {
  ...
  useEffect(() => {
    axios
      .get(`https://get-your-placement.onrender.com/api/auth/dsa`) 
      .then(({ data }) => {
  ...
  const markSolved = (q) => {
    axios.post(`https://get-your-placement.onrender.com/api/auth/dsa/solve`, { question: q }) 
      .then(({ data }) => {
        setSolved(data.solved);
        setUnsolved(data.unsolved);
      })
  ...
  const markUnsolve = (q) => {
    axios.post(`https://get-your-placement.onrender.com/api/auth/dsa/unsolve`, { question: q })
      .then(({ data }) => {
        setSolved(data.solved);
        setUnsolved(data.unsolved);
      })
